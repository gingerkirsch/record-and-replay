...
public class Parameters {
	...
	public static String OUTPUT_JIMPLE_SYMBERLEAP = "jimpleSymberLEAP"; // ** to
																		// distinguish
																		// output
																		// folders
																		// when
																		...
																		// SymberLEAP
																		// mode
	public static String PHASE_RECORD_SYMBERLEAP = "runtimeSymberLEAP"; // ** to
																		// distinguish
																		// output
																		// folders
																		// when
																		...
																		// SymberLEAP
																		// mode
	public static String PHASE_REPLAY_SYMBERLEAP = "replaySymberLEAP"; // ** to
																		// distinguish
																		// output
																		// folders
																		// when
	...
	public static boolean removeSync = true; // ** tells whether the original
												// synchronization calls are
												// removed from the bytecode or
												// not (this should be set to
												// true!)
	public static boolean traceSharedMem = true; // ** tells whether the shared
													// memory access order is to
													// be traced or not
	public static boolean isLEAPmode = false; // ** tells whether the trace mode
												// is similar to LEAP (thread
												// access vectors w.r.t shared
												// variables) or traditional
												// symber (vector clocks per
												// thread)
