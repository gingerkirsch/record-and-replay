...
public class TransformClass
{
    ...
    public void processAllAtOnce(String[] args, Visitor visitor) {
    	...
    	String mainclass = args[0];
    	 try {
             printer = new FileWriter(System.getProperty("user.dir")+System.getProperty("file.separator")+"tmp"+System.getProperty("file.separator")+mainclass);
	     } catch (IOException e) {
	             e.printStackTrace();
	     }
        ...
        //print("\n*** Instrumented SPE access number: "+ Visitor.instrusharedaccessnum);
       ...
       // print("\n*** *** *** *** *** *** *** *** *** *** ");
        ...
        print("\n*** SYNCHRONIZATION VARIABLES ["+ Visitor.syncObjIndexMap.size()+"]"); 
	...
	{	
		...
		String[] args1 = {"-cp",".","-pp",//"-validate",
				mainclass,"-d",path,"-f","jimple", "-x","org.apache.xalan.", "-x","org.apache.xpath.", "-i","org.apache.derby.",
		...
		String[] args2 = {"-cp",".","-pp",mainclass,"-d",path, "-x","org.apache.xalan.", "-x","org.apache.xpath.", "-i","org.apache.derby.",
				...
				"-x","java.","-x","javax.","-x","sun.","-x","com.","-x","jrockit.","-x","edu.","-x","checkers.","-x","org.xmlpull.","-x","org.apache.xml.","-x","org.apache.xpath."};
	...
	private void transformReplayVersion(String mainclass) 
	{
		...
		String[] args2 = {"-cp",".","-pp",//"-validate",
				mainclass,"-d",path, "-x","org.apache.xalan.", "-x","org.apache.xpath.", "-i","org.apache.derby.",
				...
				"-x","java.","-x","javax.","-x","sun.","-x","com.","-x","jrockit.","-x","edu.","-x","checkers.","-x","org.xmlpull.","-x","org.apache.xml."};
	...
	private void setRecordOptions(String mainclass)
	{
       ...
       if(appclass.declaresMethodByName("main")) //** to avoid crashing when it doens't exist a main class
	...
	private void setReplayOptions(String mainclass)
	{
       ...
       SootClass appclass = Scene.v().loadClassAndSupport(mainclass);
       if(appclass.declaresMethodByName("main")) //** this avoids a crash when the instrumented classes don't have a main method
			Scene.v().setMainClass(appclass);
