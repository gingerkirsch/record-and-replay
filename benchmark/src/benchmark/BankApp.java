...
public class BankApp {
	...
	protected static final int DEFAULT_NUM_ACCOUNTS = 62;  //** should be equal to the number of indexes in class BankBenchmark (for 32 SPEs - 30 accounts; 64 SPEs - 62 accounts)
